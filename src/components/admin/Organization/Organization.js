...
const Organization = () => {
    ...
    const tiles = [
        ...
        { title: 'Manage Investors', icon: <FaUserTie />, description: 'Investor management', color: '#f479b7', link: '/manage-investors' },
        { title: 'Fund Mapping', icon: <FaMap />, description: 'Map funds to projects', color: '#16a085', link: '/fund-mapping' },
        ...
        { title: 'AdHocQuery', icon: <FaSearch />, description: 'Define AdHoc Queries', color: '#2980b9', link: '/ad-hoc-query' },
