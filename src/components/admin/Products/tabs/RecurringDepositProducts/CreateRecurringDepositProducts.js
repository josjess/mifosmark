...
const CreateRecurringDepositProducts = () => {
        ...
        const fetchData = async () => {
            try {
                ...
                setFormData((prevData) => ({
                    ...prevData,
                    recurringDepositProductTemplate: recurringDepositProductTemplateResponse.data,
                }));
            } catch (error) {
                ...
                if (chart.id === chartId) {
                    const updatedSlabs = chart.slabs.map((slab) => {
                        if (slab.id === slabId) {
                            ...
                            const backendChartTemplate = formData.recurringDepositProductTemplate.chartTemplate;
                        ...
                        <div className="staged-form-row">
                            <div className="staged-form-field">
                                ...
                                >
                                    ...
                                    {formData.recurringDepositProductTemplate?.currencyOptions?.map((option) => (
                        ...
                        <div className="staged-form-row">
                            ...
                            <div className="staged-form-field">
                                ...
                                >
                                    ...
                                    {formData.recurringDepositProductTemplate?.interestCompoundingPeriodTypeOptions?.map(
                                        (option) => (
                            ...
                            <div className="staged-form-field">
                                ...
                                >
                                    ...
                                    {formData.recurringDepositProductTemplate?.interestPostingPeriodTypeOptions?.map(
                                        (option) => (
                                            <option key={option.id} value={option.id}>
                                                {option.value}
                                            </option>
                        ...
                        <div className="staged-form-row">
                            ...
                            <div className="staged-form-field">
                                ...
                                >
                                    ...
                                    {formData.recurringDepositProductTemplate?.interestCalculationTypeOptions?.map(
                                        (option) => (
                                            <option key={option.id} value={option.id}>
                                                {option.value}
                                            </option>
                            ...
                            <div className="staged-form-field">
                                ...
                                >
                                    ...
                                    {formData.recurringDepositProductTemplate?.interestCalculationDaysInYearTypeOptions?.map(
                                        (option) => (
                                            <option key={option.id} value={option.id}>
                                                {option.value}
                                            </option>
                    ...
                    <div className="staged-form-settings">
                        ...
                        <div className="staged-form-row">
                            <div className="staged-form-field">
                                <label>
                                    <input
                                        type="checkbox"
                                        checked={formData.Settings?.isMandatoryDeposit || false}
                                        onChange={(e) =>
                                            handleFieldChange("Settings", "isMandatoryDeposit", e.target.checked)
                                        }
                                    />
                            ...
                            <div className="staged-form-field">
                                <label>
                                    <input
                                        type="checkbox"
                                        checked={formData.Settings?.adjustAdvancePayments || false}
                                        onChange={(e) =>
                                            handleFieldChange("Settings", "adjustAdvancePayments", e.target.checked)
                                        }
                                    />
                        ...
                        <div className="staged-form-field">
                            <label>
                                <input
                                    type="checkbox"
                                    checked={formData.Settings?.allowWithdrawals || false}
                                    onChange={(e) =>
                                        handleFieldChange("Settings", "allowWithdrawals", e.target.checked)
                                    }
                                />
                                Allow Withdrawals
                            </label>
                        ...
                        <div className="staged-form-row">
                            ...
                            <div className="staged-form-field">
                                ...
                                >
                                    <option value="">Select Type</option>
                                    {formData.recurringDepositProductTemplate.lockinPeriodFrequencyTypeOptions?.map((option) => (
                                        <option key={option.id} value={option.id}>
                                            {option.value}
                                        </option>
                                    ))}
                        ...
                        <div className="staged-form-row">
                            ...
                            <div className="staged-form-field">
                                ...
                                >
                                    <option value="">Select Type</option>
                                    {formData.recurringDepositProductTemplate.periodFrequencyTypeOptions?.map((option) => (
                                        <option key={option.id} value={option.id}>
                                            {option.value}
                                        </option>
                                    ))}
                        ...
                        <div className="staged-form-row">
                            ...
                            <div className="staged-form-field">
                                ...
                                >
                                    ...
                                    {formData.recurringDepositProductTemplate.preClosurePenalInterestOnTypeOptions?.map((option) => (
                                        <option key={option.id} value={option.id}>
                                            {option.value}
                                        </option>
                                    ))}
                            ...
                            {formData.Settings?.isWithholdTaxApplicable && (
                                <div className="staged-form-field">
                                    ...
                                    >
                                        ...
                                        {formData.recurringDepositProductTemplate.taxGroupOptions?.map((option) => (
                                            <option key={option.id} value={option.id}>
                                                {option.value}
                                            </option>
                                        ))}
                    ...
                    <div className="staged-form-interest-rate-chart">
                        ...
                        {slabModal.isOpen && (
                            <SlabModal
                                ...
                                backendOptions={formData.recurringDepositProductTemplate}
                            />
                        )}
                        ...
                        <div className="staged-form-row">
                            <div className="staged-form-field">
                                ...
                                >
                                    ...
                                    {formData.recurringDepositProductTemplate?.chargeOptions
                                        ?.filter(
                                            (option) =>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    const selectedCharge = formData.recurringDepositProductTemplate?.chargeOptions?.find(
